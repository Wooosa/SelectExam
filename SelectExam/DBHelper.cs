...
using System.Configuration;
    ...
    public class DBHelper
    {
        ...
        public string connStr = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=#data.mdb;Persist Security Info=False";
        ...
        public void SetParameter(string parameterName, object parameterValue)
        {
            ...
            adp.SelectCommand.Parameters.Add(new OleDbParameter(parameterName, parameterValue));
        }
        /// <summary>
        /// 设置输出参数（不指定长度，适合非字符串）
        /// </summary>
        ...
        public void SetOutParameter(string parameterName, OleDbType dbType, int size)
        {
            parameterName = "@" + parameterName.Trim();
            OleDbParameter parameter = new OleDbParameter(parameterName, dbType, size);
            parameter.Direction = ParameterDirection.Output;
            adp.SelectCommand.Parameters.Add(parameter);
        }
        /// <summary>
        ...
        public OleDbDataReader ExecDataReader()
        {
